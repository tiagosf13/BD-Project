...
-- Reviews
    INSERT INTO Reviews
    VALUES
        (1, 5000, 10001, 'Great product!', 5.0, '2024-02-20'),
        (2, 5072, 10005, 'Very satisfied', 4.0, '2024-03-15'),
        (3, 5061, 10009, 'Not bad', 3.0, '2024-05-10'),
        (4, 5050, 10003, 'Excellent quality', 5.0, '2024-04-20'),
        (5, 5060, 10000, 'Quite good', 4.0, '2024-03-25'),
        (6, 5043, 10007, 'Needs improvement', 2.0, '2024-03-01'),
        (7, 5031, 10002, 'Very good', 4.0, '2024-04-07'),
        (8, 5071, 10004, 'Top notch', 5.0, '2024-05-15'),
        (9, 5060, 10008, 'Just okay', 3.0, '2024-02-25'),
        (10, 5072, 10006, 'Perfect fit', 5.0, '2024-04-01');